 ...
 * @e_ident: A pointer to an array that contains the ABI version of an ELF
 * file
 */
 ...
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array that contains the ELF type.
 */
...
/**
 * main - Shows content of ELF file.
 * @argc: Argument count
